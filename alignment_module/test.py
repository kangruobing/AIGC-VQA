...
def main():
    ...
    parser.add_argument('--output_file', type=str, default='alignemnt_predictions.csv')
    ...
    if is_ensemble:
        models = [load_model(path, device) for path in args.model_path]
        ...
        model = load_model(args.model_path[0], device)
        ...
        output_file = os.path.join(args.output_file, f"{model_name}_{args.output_file}")
