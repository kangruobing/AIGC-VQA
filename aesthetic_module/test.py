...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='/root/autodl-tmp/VQualA/aesthetic_module/results')
    parser.add_argument('--output_file', type=str, default='aesthetic_predictions.csv')
